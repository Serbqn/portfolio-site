    ...
    <section className="border-y border-surface-200 bg-surface-50">
      <div className="container-wide grid gap-12 py-section lg:grid-cols-12 lg:gap-16">
        <div className="lg:col-span-5">
          ...
          <p className="mt-4 text-pretty text-surface-600">
        ...
        <div className="lg:col-span-7">
          <ul className="grid gap-3">
            {skills.map((s) => (
              <li
                key={s.name}
                className="grid grid-cols-[1fr_auto] items-center gap-4 border-b border-surface-200 py-3 last:border-b-0"
              >
                <div>
            ...
            <div className="mt-8">
              ...
              <ul className="mt-3 flex flex-wrap gap-1.5">
                {tools.map((t) => (
                  <li
                    key={t}
                    className="inline-flex items-center rounded-md border border-surface-200 bg-white px-2.5 py-1 text-xs font-medium text-surface-700"
                  >
                    {t}
                  </li>
                ))}
